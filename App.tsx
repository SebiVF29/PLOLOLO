...
// Emergency safe page template
const EmergencyPage = ({ title, icon, description }: { title: string; icon: string; description: string }) => (
  <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto bg-background/80 dark:bg-background/90">
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
      ...
      <div className="bg-card text-card-foreground p-8 rounded-2xl shadow-lg">
        <div className="text-center mb-6">
          ...
          <p className="text-foreground/70 mb-4">This section is stable and working properly.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-purple-500/10 text-purple-600 p-4 rounded-lg text-center">
...
const ProtectedRoutes: React.FC = () => (
  <AppLayout>
    <Routes>
      ...
      <Route path="/classes" element={<EmergencyPage title="Classes" icon="book-open" description="Organize your class schedule" />} />
      <Route path="/exams" element={<EmergencyPage title="Exams" icon="academic-cap" description="Track your upcoming exams" />} />
      <Route path="/work" element={<EmergencyPage title="Work" icon="briefcase" description="Manage your work tasks" />} />
      <Route path="/ai-assistant" element={<EmergencyPage title="AI Assistant" icon="sparkles" description="Get help with your studies" />} />
      <Route path="/settings" element={<EmergencyPage title="Settings" icon="cog" description="Customize your Chronofy experience" />} />
