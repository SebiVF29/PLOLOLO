...
// Safe working page template
const SafePage = ({ title, icon, description }: { title: string; icon: string; description: string }) => (
  <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto bg-background/80 dark:bg-background/90">
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
      ...
      <div className="bg-card text-card-foreground p-8 rounded-2xl shadow-lg">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-semibold mb-2">{title} Functionality</h2>
          <p className="text-foreground/70 mb-4">This section is working and will be enhanced step by step.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-primary/10 text-primary p-4 rounded-lg text-center">
            ...
            <p className="font-medium">✅ Navigation Working</p>
          </div>
...
const ProtectedRoutes: React.FC = () => (
  <AppLayout>
    <Routes>
      ...
      <Route path="/focus-hub" element={<SafePage title="Focus Hub" icon="clock" description="Boost your productivity with focus sessions" />} />
      <Route path="/classes" element={<SafePage title="Classes" icon="book-open" description="Organize your class schedule" />} />
      <Route path="/exams" element={<SafePage title="Exams" icon="academic-cap" description="Track your upcoming exams" />} />
      <Route path="/work" element={<SafePage title="Work" icon="briefcase" description="Manage your work tasks" />} />
      <Route path="/ai-assistant" element={<SafePage title="AI Assistant" icon="sparkles" description="Get help with your studies" />} />
      <Route path="/settings" element={<SafePage title="Settings" icon="cog" description="Customize your Chronofy experience" />} />
